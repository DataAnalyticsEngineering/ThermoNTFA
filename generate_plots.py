...
mode_fn = "fix/simple_3d_rve_B1-B6_16x16x16_10samples_fix.h5"
...
# - Compare the results
##############################################################################"""
F = h5py.File("vtk_notch/NTFA293K_fine_temp_293-800.h5", "r")
...
fname = "all_results_ms9p_16x16x16_100s_N24.h5"
...
with h5py.File("daten_kerbgrund_NTFA_FE.h5", "r") as F:
    eps = np.array(F["/eps"])
